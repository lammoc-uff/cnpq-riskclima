"""NCEP Reanalysis 1 acquisition helpers and SACZ field catalog."""
...
def download(
    ...
    """Download annual pressure-level fields from NCEP Reanalysis 1.
    ...
    for variable in variables:
        for year in range(iyear, fyear + 1):
            url = (
                ...
                f"ncep.reanalysis.dailyavgs/{level_type}/{variable}.{year}.nc"
            )
            downloads.append(
