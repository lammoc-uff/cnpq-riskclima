...
def build_parser() -> argparse.ArgumentParser:
    """Build the ERA5-Land calibration parser."""
    parser = argparse.ArgumentParser(description="Build the configured ERA5-Land calibration.")
    add_common_arguments(parser)
    add_calibration_policy_argument(parser)
    return parser


def run(settings: ERA5LandSettings) -> Path:
    """Build and replace the configured ERA5-Land calibration."""
    ...
    calibration.attrs.update(
        {
            ...
            "calculation": "maximum of non-overlapping 24-hour ERA5-Land blocks",
...
def main(argv: Sequence[str] | None = None) -> None:
    """Run ERA5-Land calibration according to policy."""
