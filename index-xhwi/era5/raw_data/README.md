...
- ``r_prev_STARTYEAR-ENDYEAR/`` — directory containing ERA5 relative humidity files or the corresponding Zarr store
- ``t2m_prev_STARTYEAR-ENDYEAR/`` — directory containing ERA5 2 m air temperature files or the corresponding Zarr store
