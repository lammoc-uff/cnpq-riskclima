...
from src.config.settings import CHUNKS, WRITE_CONSOLIDATED, OVERWRITE, TARGET_CAL_VAR
...
def process_single_month(
    ...
    sorted_da, cdf_da = compute_sorted_and_cdf(cal_m[TARGET_CAL_VAR], dim="calibration_time")
    ...
    ds_daily, ds_monthly = monthly_indicators(val_m)
