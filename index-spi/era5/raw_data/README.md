...
When `SPI_USE_SHAPEFILE=True`, CDS receives the rectangular extent of the configured shapefile. Raw files therefore retain that rectangle and can contain cells outside Brazil. The exact country mask is applied locally after monthly precipitation preparation and before SPI calculation.
